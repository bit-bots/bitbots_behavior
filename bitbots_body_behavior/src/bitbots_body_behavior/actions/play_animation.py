...
class PlayAnimationGoalieFallMiddle(AbstractPlayAnimation):
    def chose_animation(self):
        rospy.loginfo("PLAYING GOALIE FALLING MIDDLE ANIMATION")
        return self.blackboard.goalie_falling_middle_animation
