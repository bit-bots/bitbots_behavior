...
class PatternSearchGoalWithBall(AbstractActionElement):
    """
    ...
    def __init__(self, blackboard, dsd, parameters=None):
        super(PatternSearchGoalWithBall, self).__init__(blackboard, dsd, parameters)
        self.index = 0
        self.pattern = self.blackboard.config['search_pattern_goal_with_ball']
